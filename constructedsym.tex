...
Let us make a note here about the meaning of these subject oriented adverbs that will become relevant shortly. While we won't give a formal semantics, we think it's clear that the relation that these adverbs have is importantly different than manner adverbs. Consider, for instance, the somewhat strained interpretation that \textit{she walked the dog happily} can get when \textit{happily} understood as a manner adverb. On this interpretation the walk that the dog is being made to endure is a happy walk. On this interpretation, nothing about the dog's state is communicated. When \textit{happily} is subject, oriented, by contrast, it describes an attitude the subject has towards the event. In (\ref{ex:dog}a), the dog is said to be happy or willing to be the agent of walking. We suggest the following observation.
\begin{exe}
\raggedright
  \ex \label{ex:subjectattitude} Only subjects can have an attitude towards the event denoted by the VP they are the subjects of.
\end{exe}
